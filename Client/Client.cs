...
namespace Client
{
    class client
    {
        ...
        public static string SubmitSolution(Solution solution)
        {
            // returns verdict and submits solution to server
            return "chararara";
        }

        public static List<(int, string)> RequestProblems(int count)
        {
            // returns list of problem IDs and Names from server
            return new List<(int, string)>();
        }

        public static Problem RequestProblem(int id)
        {
            // returns problem from server
            return new Problem(1,"gg","ggwp",1500,"input","output");
        }
    }
}
